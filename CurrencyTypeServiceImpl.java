...
public class CurrencyTypeServiceImpl implements CurrencyTypeService {
	...
	/*
	 * @Autowired public CurrencyTypeServiceImpl(CurrencyTypeRepository
	 * currencyTypeRepository, CurrencyTypeMapper currencyTypeMapper) {
	 * this.currencyTypeRepository = currencyTypeRepository; this.currencyTypeMapper
	 * = currencyTypeMapper; }
	 */
