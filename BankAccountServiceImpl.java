...
public class BankAccountServiceImpl implements BankAccountService {
	...
	/*
	 * @Autowired public BankAccountServiceImpl(BankAccountMapper bankAccountMapper,
	 * BankAccountRepository bankAccountRepository, Constants constants,
	 * SaldoRepository saldoRepository, CurrencyTypeRepository
	 * currencyTypeRepository, BankAccountTypeRepository bankAccountTypeRepository,
	 * UserRepository userRepository, SaldoMapper saldoMapper) {
	 * this.bankAccountMapper = bankAccountMapper; this.bankAccountRepository =
	 * bankAccountRepository; this.constants = constants; this.saldoRepository =
	 * saldoRepository; this.currencyTypeRepository = currencyTypeRepository;
	 * this.bankAccountTypeRepository = bankAccountTypeRepository;
	 * this.userRepository = userRepository; this.saldoMapper = saldoMapper; }
	 */
	...
	public BankAccountOut create(@NotNull BankAccountIn bankAccountIn, String userIdentifier) {
		...
		String mail = 
	            userRepository.findByIdentifier(userIdentifier).orElseThrow(() -> new RuntimeException("User not found")).getEmail();				
		emailService.sendAccountMail(mail, userIdentifier);
